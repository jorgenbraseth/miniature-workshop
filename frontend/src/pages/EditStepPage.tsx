...
export default function EditStepPage({ unitId, stepId }: { unitId: string; stepId: string }) {
  ...
  const handleSubmit = async (e: any) => {
    ...
    if (!unit || !step || allTechniques.length === 0) {
        ...
        <div class="card">
          ...
          <div class="mb-6">
            ...
            <p class="text-sm text-workshop-500 mt-2">
              Add photos to document this painting step. Use the camera for real-time capture, upload files, or remove existing photos.
            </p>
          </div>
        </div>
