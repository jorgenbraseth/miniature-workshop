  ...
  return (
    <div>
      <div class="flex justify-between items-center mb-8">
        ...
        <button onClick={() => route('/units/new')} class="btn-primary flex items-center space-x-2">
          <span>🖌️</span>
          <span>New Unit</span>
        </button>
      </div>
              ...
              {thumbnailPhoto ? (
                <div class="relative h-48 mb-4 -mx-6 -mt-6">
                  ...
                  <div class="absolute top-3 right-3 flex items-center gap-2">
                    <span
                      class={`px-2 py-1 text-xs rounded-full font-medium backdrop-blur-sm ${
                        unit.isComplete
                    ...
                    <span
                      class={`px-2 py-1 text-xs rounded-full backdrop-blur-sm ${
                        unit.syncStatus === 'synced'
                          ? 'bg-success-100/90 text-success-800'
                          : unit.syncStatus === 'syncing'
                            ? 'bg-warning-100/90 text-warning-800'
                            : unit.syncStatus === 'conflict'
                              ? 'bg-error-100/90 text-error-800'
