      ...
      <form onSubmit={handleSubmit} class="card">
        <div class="space-y-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2">Faction</label>
              <input
                type="text"
                class="input-field"
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-2">Number of Models</label>
            <input
              type="number"
              min="1"
              max="50"
        ...
        <div class="flex gap-4 mt-8">
          ...
          <button type="button" onClick={() => route('/units')} class="btn-secondary">
            Cancel
          </button>
        </div>
      </form>
