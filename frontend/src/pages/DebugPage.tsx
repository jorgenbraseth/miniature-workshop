      ...
      <div class="card mb-6">
        ...
        <div class="space-y-3">
          ...
          <div class="flex items-center justify-between p-3 bg-gray-50 rounded">
            ...
            <span class={`px-3 py-1 rounded text-sm font-medium ${getStatusClass(!!googleClientId)}`}>
          ...
          <div class="space-y-3">
            <div class="p-4 bg-green-50 border border-green-200 rounded">
              ...
              <p class="text-sm text-green-700">
                <strong>Client ID:</strong> <code class="bg-green-100 px-2 py-1 rounded">{googleClientId}</code>
              </p>
      ...
      <div class="card mb-6">
        ...
        <div class="space-y-3">
          <div class="p-3 bg-gray-50 rounded">
            <p class="font-medium">API URL: <code class="bg-gray-200 px-2 py-1 rounded">{apiUrl || 'Not configured'}</code></p>
          ...
          {!googleClientId && (
            <div class="p-3 bg-yellow-50 border border-yellow-200 rounded">
              ...
              <ol class="list-decimal list-inside mt-2 space-y-1 text-yellow-700">
                <li>Check if <code>GOOGLE_CLIENT_ID</code> secret is set in GitHub repository settings</li>
