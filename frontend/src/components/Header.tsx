      ...
      <div class="container mx-auto px-4 relative">
        <div class="flex items-center justify-between h-16">
          ...
          <div class="flex items-center">
            <div onClick={navigateHome} class="flex items-center space-x-3 group cursor-pointer">
              ...
              <div class="flex flex-col">
                <span class="text-xl font-bold text-workshop-900 group-hover:text-paint-600 transition-colors duration-200">
                  Miniature Workshop
                </span>
